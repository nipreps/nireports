...
#
"""
Tests for the :mod:`nireports.core` module.
"""
import os
import tempfile
...
from nireports.core import Report
...
def test_report1():
    test_data_path = pkgrf(
        "nireports", os.path.join("data", "tests", "work", "reportlets")
    )
...
def test_process_orderings_small(
    ...
    report = test_report1
    report.init_layout()
    entities, value_combos = report._process_orderings(
        orderings, report.layout
    )
